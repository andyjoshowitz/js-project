...
$(function(){
  ...
  // this stuff came from reviews page

  // for Review show page
  ...
  // };
  //
  // Review.prototype.renderComment = function() {
  //   var html = "";
  //   html += '<h3 class="header">' + this.course.title + "</h3>";
  //   html += '<h3 class="sub-header">' + "Review #" + this.id + "</h3>";
  //   html += '<h4 class="ratings">' + "Ratings" + '</h4>';
  //   html += '<p>' + this.overall_quality+ "</p>";
  //   return html;
